...
\newcommand{\myname}{Manikanta Puttoj}
\newcommand{\studentID}{23249889}
\newcommand{\mytitle}{Developing an AI-Powered Zero-Trust Cybersecurity Framework for Malware Prevention}

\newcommand{\wordcount}{15000} %change this for your word count! To determine the word count, run the following from a terminal: texcount -total researchProject.tex -inc 

\newcommand{\supervisor}{Mosab Mohmad}
\newcommand{\supervisortwo}{XXX} %for industry based research projects only!

\newcommand{\myyear}{2025}
\newcommand{\duedate}{28/11/2025}
